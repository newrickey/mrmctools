...
The package's functions are still being tweaked. Use is evolving, and user feedback is appreciated.  Post questions or comments on the [github repository](https://github.com/newrickey/mrmctools).  
